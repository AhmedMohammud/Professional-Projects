...
//    }
    ...
    public void promote(int row, int col, boolean isBlack){
        switch(this.character){
            case '\u2659':
                if(row == 7){//black
                    Scanner promoteChoice = new Scanner(System.in);
                    String prom;
                    System.out.println("Choose a character to promote: knight, queen, bishop, rook");
                    prom = promoteChoice.nextLine();
                    if(prom.equals("knight")){
                        this.setCharacter('\u265E');
                    }
                    else if(prom.equals("queen")){
                        this.setCharacter('\u265B');
                    }
                        ...
                        System.out.println("Choose again: knight, queen, bishop, rook");
                    }
